      ...
      <div className="max-w-screen-xl mx-auto pb-8 px-4 pt-[5vh] md:pt-[10vh] lg:px-6">
        <div className="mx-auto-sm text-center mb-8 lg:mb-16">
          ...
          <div className={bodyTextStyles.descriptionCenter}>
            We&apos;re your premier source for exceptional talent. Our experts,
            with their deep understanding of Australian accounting and financial
            services are the perfect fit for your team.
          </div>
        </div>
