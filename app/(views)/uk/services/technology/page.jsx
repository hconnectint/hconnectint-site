      ...
      <SectionTextRightDesc
        description={
          <div className="space-y-4">
            <div>
              We partner with leading UK enterprises to drive the future of
              smart and scalable product development. Whether it’s reimagining
              infrastructure or crafting connected products, we focus on
              delivering tailored, high-impact solutions that anticipate the
              future of business.
              <br />
            </div>
            <div>
