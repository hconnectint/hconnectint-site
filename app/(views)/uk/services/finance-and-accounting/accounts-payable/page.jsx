  ...
  return (
    <div>
        ...
        description={
          <div className={`space-y-4  ${bodyTextStyles.descriptionLeft}`}>
            ...
            <div>
              ...
              essential to building strong supplier relationships within the UK
              market.
            </div>
            <div>
              ...
              for businesses in the United Kingdom and across the world.
            </div>
          </div>
        }
        component={
      ...
      <SectionTextLeftLongBlue
        ...
        description="Our AP solutions are crafted with a deep understanding of finance processes in the UK, leveraging cutting-edge automation technology to streamline operations. At H Connect International, our team works closely with you to eliminate silos between AP and procurement, enabling improved business results and enhancing the experience for both suppliers and employees"
        component={
          <div className="max-w-[100vw] w-[100vw] md:max-w-[40vw] md:w-[40vw] px-[2vw] ">
            <div
              className={cn(
