      ...
      <div className="">
        <div className="mb-[20vh]  md:my-0">
          <LandingPageInner
            ...
            description={
              <div>
                e provide access to dedicated resources for specialised
                positions with a customised approach that ensures the perfect
                fit for any job within the UK market. We handle the entire
                process, end-to-end, including sourcing, onboarding, initial
                set-up, and infrastructure tailored to your operations. <br />
                <div className="">
