        ...
        description={
          <>
            <div className="space-y-4">
              ...
              <div>
                Our teams are passionate about delivering exceptional HR support
                across all areas for businesses in the UK, from recruitment to
                payroll and beyond. By managing administrative tasks, we enable
                you to concentrate on the meaningful journeys of your employees,
                addressing their needs, enabling their development, and solving
                any challenges that arise.
              </div>{" "}
              <div>
                With our customised solutions tailored for the UK market, you
                can streamline HR operations, reduce costs, and scale your
                business faster. We’re here to take care of the
