        ...
        description={
          <>
            <div className="space-y-4">
              <div>
                We collaborate with leading UK enterprises to deliver strategic
                consulting services that drive sustainable growth and innovation
                through outsourcing. With extensive experience supporting
                corporations across the UK, we provide customised consulting
                solutions tailored to your specific region and industry.
              </div>{" "}
              <div>
            ...
            <div className={`space-y-4  ${bodyTextStyles.descriptionCenter}`}>
              <div className="w-[100%] ">
                <div>
                  ...
                  approach ensures that you achieve measurable outcomes specific
                  to the UK market. We carefully assess your unique goals,
                  challenges, and resources to determine the most suitable
                  methodology for your project. Whether you require the
